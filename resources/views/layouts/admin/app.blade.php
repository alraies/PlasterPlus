...
<head>
    ...
    <!-- Font -->
<!-- <link href="{{asset('public/assets/admin')}}/fonts/NotoKufiArabic-Regular.woff" rel="stylesheet"> -->
    ...
    <link rel="stylesheet" href="{{asset('public/assets/admin')}}/fonts/stylesheet.css">
    @stack('css_or_js')
...
<main id="content" role="main" class="main pointer-event" style="font-family: 'Noto Kufi Arabic',sans-serif">
    <!-- Content -->
@yield('content')
<!-- End Content -->
