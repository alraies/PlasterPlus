            ...
            <div class="navbar-vertical-content" style="background-color: #334257;">
                ...
                <!-- End Orders -->
                    ...
                    @if(\App\CentralLogics\Helpers::module_permission_check('category'))
                     ...
                     <li class="navbar-vertical-aside-has-menu {{Request::is('admin/org*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:" title="{{__('messages.org')}}"
                            >
                                <i class="tio-pages nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{__('messages.orgs')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('admin/org*')?'block':'none'}}">
                                <li class="nav-item {{Request::is('admin/org/add')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.org.add')}}"
                                       title="{{__('messages.org')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{__('messages.addorg')}}</span>
                                    </a>
                                </li>
