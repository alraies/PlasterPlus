                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="orgId" id="choice_orgs" data-placeholder="{{__('messages.select')}} {{__('messages.org')}}"
                                        class="form-control js-select2-custom">
                                    @foreach(\App\Models\Org::all() as $org)


                                                <option value="{{$org->orgId}}" {{$restaurant->orgId == $org->orgId? 'selected': ''}}>{{$org->OrgName}}</option>
