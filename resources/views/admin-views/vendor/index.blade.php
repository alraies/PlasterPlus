                ...
                <form action="{{route('admin.vendor.store')}}" method="post" enctype="multipart/form-data" class="js-validate">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label" for="choice_orgs">{{__('messages.org')}}<span
                                        class="input-label-secondary" title="{{__('messages.select_org_for_map')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.select_org_for_map')}}"></span></label>
                                <select name="orgId" id="choice_orgs" required
                                        class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.org')}}">
                                        <option value="" selected disabled>{{__('messages.select')}} {{__('messages.org')}}</option>
                                    @foreach(\App\Models\Org::all() as $org)
