    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} {{__('messages.new')}} {{__('messages.offer')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="offer_form"
                        ...
                        @foreach(json_decode($language) as $lang)
                            <div class="card p-4 {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" {{$lang == $default_lang? 'required':''}} name="name[]" id="{{$lang}}_name" class="form-control" placeholder="{{__('messages.new_offer')}}" oninvalid="document.getElementById('en-link').click()">
                                </div>
                    ...
                    <div class="card p-4" id="{{$default_lang}}-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="name[]" class="form-control" placeholder="{{__('messages.new_offer')}}" required>
                        </div>
                        ...
                        <div class="col-md-6 col-6">
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control js-select2-custom"
                                        onchange="getRequest('{{url('/')}}/vendor-panel/offer/get-categories?parent_id='+this.value,'sub-categories')">
                        ...
                        <div class="col-md-6 col-6">
                            <div class="form-group">
                                ...
                                <select name="sub_category_id" id="sub-categories"
                                        ...
                                        onchange="getRequest('{{url('/')}}/vendor-panel/offer/get-categories?parent_id='+this.value,'sub-sub-categories')">
                    ...
                    <div class="form-group">
                        <label>{{__('messages.offer')}} {{__('messages.image')}}</label><small style="color: red">* ( {{__('messages.ratio')}} 1:1 )</small>
...
@push('script_2')
    ...
    <script>
        ...
        function combination_update() {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('vendor.offer.variant-combination')}}',
            ...
            $.post({
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        ...
                        setTimeout(function () {
                            location.href = '{{route('vendor.offer.list')}}';
                        }, 2000);
                    }
                }
            });
