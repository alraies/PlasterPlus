    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle mr-1"
                       href="{{route('vendor.customer.view',[$customer['id']-1])}}"
                    ...
                    <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle"
                       href="{{route('vendor.customer.view',[$customer['id']+1])}}" data-toggle="tooltip"
        ...
        <div class="row" id="printableArea">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                                    href="{{route('vendor.order.details',['id'=>$order['id']])}}" title="{{__('messages.view')}}"><i
                        ...
                        <div class="card-body">
                            <div class="media align-items-center" href="javascript:">
                                <div class="avatar avatar-circle mr-3">
                                    <img
                                        class="avatar-img"
                                        onerror="this.src='{{asset('assets/vendor/img/160x160/img1.jpg')}}'"
            ...
            <div class="form-group">
                <label>{{__('messages.food')}} {{__('messages.image')}}</label><small style="color: red">*</small>
