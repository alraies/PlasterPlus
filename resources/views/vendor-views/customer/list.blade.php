            ...
            <div class="card-header">
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-lg-6 mb-3 mb-lg-0">
                        ...
                        <form action="{{route('vendor.customer.list')}}">
                            <!-- Search -->
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <button type="reset" class="btn btn-info mx-1" onclick="location.href = '{{route('vendor.customer.list')}}'">{{__('messages.reset')}}</button>
                                @endif
                            </div>
                            <!-- End Search -->
                        </form>
...
@push('script_2')
    ...
    <script>
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('vendor.customer.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
