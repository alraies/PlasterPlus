                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="hs-unfold float-right">
                            ...
                            <a class="btn btn-sm btn-primary" onclick="order_status_change_alert('{{route('vendor.order.status',['id'=>$order['id'],'order_status'=>'processing'])}}','Change status to cooking ?')" href="javascript:">{{__('messages.تحت المعالجة')}}</a>
                            @elseif ($order['order_status']=='processing')
