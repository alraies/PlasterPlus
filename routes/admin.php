...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'org', 'as' => 'org.'], function () {
            Route::get('get-orgs-data/{org}', 'OrgController@get_org_data')->name('get-orgs-data');

            Route::get('get-all', 'OrgController@get_all')->name('get-all');
            Route::group(['middleware' => ['module:org']], function () {
                Route::get('add', 'OrgController@index')->name('add');

                Route::post('store', 'OrgController@store')->name('store');
                Route::get('edit/{id}', 'OrgController@edit')->name('edit');
                Route::post('update/{id}', 'OrgController@update')->name('update');
                Route::post('store', 'OrgController@store')->name('store');
                // Route::get('IsActive/{id}/{IsActive}', 'OrgController@IsActive')->name('IsActive');
                Route::delete('delete/{id}', 'OrgController@delete')->name('delete');
                Route::post('search', 'OrgController@search')->name('search');
